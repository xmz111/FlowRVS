...
class WanTransformer3DModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin, CacheMixin):
    ...
    def forward(
        ...
        batch_size, num_channels, num_frames, height, width = hidden_states.shape
        #print('hidden_states', hidden_states.shape)  torch.Size([1, 32, 3, 56, 100])
        ...
        #encoder_hidden_states torch.Size([1, 512, 1536])
        #print('hidden_states_length', hidden_states.shape)  #hidden_states torch.Size([1, 5568, 1536])
